...
in {
  ...
  systemd = {
    ...
    network = {
      ...
      links = {
        # Altibox
        "10-wan0" = ethLink "wan0" "00:26:55:e3:5d:82";
        ...
        "15-lan0" = ethLink "lan0" "00:26:55:e3:5d:83";

        # Unused Ethernet.
        "15-eth2" = ethLink "eth2" "30:85:a9:40:0f:0b";
      };
    ...
    network.wait-online.ignoredInterfaces = ["tailscale0" "wg0"];
