...
let
  sources = {
    ...
    "collections-5.1.13" = {
      ...
      version = "5.1.13";
      src = fetchurl {
        url = "https://registry.npmjs.org/collections/-/collections-5.1.13.tgz";
        sha512 = "SCb6Qd+d3Z02corWQ7/mqXiXeeTdHvkP6TeFSYfGYdCFp1WrjSNZ3j6y8Y3T/7osGEe0iOcU2g1d346l99m4Lg==";
      };
    };
    "color-convert-1.9.3" = {
      name = "color-convert";
    ...
    "hap-nodejs-0.9.8" = {
      ...
      version = "0.9.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/hap-nodejs/-/hap-nodejs-0.9.8.tgz";
        sha512 = "+IENi8nFh/yOvVZEEIgY+nVppoXgY3mN8CfRh/I9tlhDbp3rXlsjdvHFVOgk7qJNa6cwzKu0KzNUs+n3XpO1Iw==";
      };
    };
    "har-schema-2.0.0" = {
      name = "har-schema";
    ...
    "mqtt-4.3.2" = {
      ...
      version = "4.3.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/mqtt/-/mqtt-4.3.2.tgz";
        sha512 = "cSmPOvTL9diVV7nZVHobwFR//fLZw8c1Yw04z49sLwJx45ooiiqcg2soFLYdjI4iXlkw49lP6BZ2ZRv9kGpOyw==";
      };
    };
    "mqtt-packet-6.10.0" = {
      name = "mqtt-packet";
    ...
    "number-allocator-1.0.8" = {
      ...
      version = "1.0.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/number-allocator/-/number-allocator-1.0.8.tgz";
        sha512 = "5lhaurSl3Kvn6j47S2ELzyv5X7b+UvvcZONUjL5/bFGNiOU7GkG/HUmtqef9ayEzS2i6BtsqB0FTTyu+8QrRrg==";
      };
    };
    "number-is-nan-1.0.1" = {
      name = "number-is-nan";
...
in
{
  homebridge = nodeEnv.buildNodePackage {
    ...
    version = "1.3.9";
    src = fetchurl {
      url = "https://registry.npmjs.org/homebridge/-/homebridge-1.3.9.tgz";
      sha512 = "/QYosrEmxao6EekPMU3la3j3qx0UWLcYQN01qbZ7s1ZrKp8aC+aShgNx1borFrY/0fHsZauGcbuNqFh+XSKNXw==";
    };
    dependencies = [
  ...
  homebridge-config-ui-x = nodeEnv.buildNodePackage {
    ...
    version = "4.41.5";
    src = fetchurl {
      url = "https://registry.npmjs.org/homebridge-config-ui-x/-/homebridge-config-ui-x-4.41.5.tgz";
      sha512 = "I4q4XA0QVme8dbWZRYS3SLImhsrMkMvJw0NSk8rZYyP1OsEANF2STd2+JB69MvBpyDyZ2D5p+TpTsR+iVKnS3w==";
    };
    dependencies = [
  ...
  homebridge-mqttthing = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (sources."number-allocator-1.0.8" // {
        dependencies = [
          sources."debug-4.3.3"
        ];
      })
