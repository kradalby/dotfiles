...
let
  sources = {
    ...
    "@fastify/error-3.1.0" = {
      ...
      version = "3.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@fastify/error/-/error-3.1.0.tgz";
        sha512 = "jmk3Q822+xi8jVzGsux3mWd+9O4rzVUGCqR2+JlF9LkCeeUmRdxPd2Je6S7IGMk5VTtB0xyB3crRQqklUyQ6dQ==";
      };
    };
    ...
    "@nestjs/microservices-9.2.1" = {
      ...
      version = "9.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@nestjs/microservices/-/microservices-9.2.1.tgz";
        sha512 = "ve4dqgoIaUG9VtinHHGCvf6SvtPjd3I44Mj8z8mSkcB8BEPfJnf4FNOShFBgsedtxLaiZyjpv8NCLcNVv5KKGg==";
      };
    };
    ...
    "@nestjs/platform-express-9.2.1" = {
      ...
      version = "9.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@nestjs/platform-express/-/platform-express-9.2.1.tgz";
        sha512 = "7PecaXt8lrdS1p6Vb1X/am3GGv+EO1VahyDzaEGOK6C0zwhc0VPfLtwihkjjfhS6BjpRIXXgviwEjONUvxVZnA==";
      };
    };
    ...
    "nats-2.9.2" = {
      ...
      version = "2.9.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/nats/-/nats-2.9.2.tgz";
        sha512 = "Ee1HVq/FsQrHSh0hvYJ1PhG+DtAhVG0kCXVvqEj8iL/qUge5IgGrwgXcXCBIlvp26PlWYyoMydMiIefYTD0aNw==";
      };
    };
    "negotiator-0.6.3" = {
      name = "negotiator";
...
in
{
  ...
  homebridge-config-ui-x = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (sources."@nestjs/microservices-9.2.1" // {
        dependencies = [
          sources."tslib-2.4.1"
        ];
      })
      sources."@nestjs/passport-9.0.0"
      (sources."@nestjs/platform-express-9.2.1" // {
        dependencies = [
          sources."tslib-2.4.1"
        ];
      })
