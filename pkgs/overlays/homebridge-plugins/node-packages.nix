...
let
  sources = {
    "@homebridge/plugin-ui-utils-1.0.3" = {
      ...
      version = "1.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@homebridge/plugin-ui-utils/-/plugin-ui-utils-1.0.3.tgz";
        sha512 = "p2S/czGYNRnRtMICxBUk4Uar+KCezfyxjqfStfxKgykD2082SNayVDncYUK1xRai78EGHCbif9eoyrmDweh4tQ==";
      };
    };
    ...
    "fakegato-history-0.6.5" = {
      ...
      version = "0.6.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/fakegato-history/-/fakegato-history-0.6.5.tgz";
        sha512 = "MVam/dRAeXiMBOMY+qUN8w+6Hosx9UClUsC8dVKMzRxcHkVAN4r0ptdbf7mb78fAYbmDLcEZHHNbDBitkELPmg==";
      };
    };
    ...
    "google-auth-library-9.14.1" = {
      ...
      version = "9.14.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/google-auth-library/-/google-auth-library-9.14.1.tgz";
        sha512 = "Rj+PMjoNFGFTmtItH7gHfbHpGVSb3vmnGK3nwNBqxQF9NoBpttSZI/rc0WiM63ma2uGDQtYEkMHkK9U6937NiA==";
      };
    };
    "googleapis-144.0.0" = {
      name = "googleapis";
      ...
      version = "144.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/googleapis/-/googleapis-144.0.0.tgz";
        sha512 = "ELcWOXtJxjPX4vsKMh+7V+jZvgPwYMlEhQFiu2sa9Qmt5veX8nwXPksOWGGN6Zk4xCiLygUyaz7xGtcMO+Onxw==";
      };
    };
    ...
    "hb-lib-tools-1.2.4" = {
      ...
      version = "1.2.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/hb-lib-tools/-/hb-lib-tools-1.2.4.tgz";
        sha512 = "kdyzYvAbG3c4WPISjeE2VPzGWR8sClIf3u5+qWh727oMHPNrC4ES/hI6r4HXAsokOIG3cgCTpopvElaszLRVDA==";
      };
    };
    "help-me-3.0.0" = {
      name = "help-me";
    ...
    "homebridge-lib-6.7.5" = {
      ...
      version = "6.7.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/homebridge-lib/-/homebridge-lib-6.7.5.tgz";
        sha512 = "B+UGFcDa8Kw84bIGoEIjuft+vI6HgqaOMD78iJVx4p6QG+j0xgp9fA/X50Zc0oEqILLUnRQ4L2xELRoiAs/Hkg==";
      };
    };
...
in
{
  homebridge-philips-tv6 = nodeEnv.buildNodePackage {
    ...
    version = "1.0.7";
    src = fetchurl {
      url = "https://registry.npmjs.org/homebridge-philips-tv6/-/homebridge-philips-tv6-1.0.7.tgz";
      sha512 = "kSUhGcuGjN7lGsGszRJQgOO217aLoFy3M05OHEZnHavTDtRD2HtVLzrtzjKlQV2AHQ4TzA2kNOx9PM46C3h5oQ==";
    };
    dependencies = [
      sources."ajv-6.12.6"
      sources."asn1-0.2.6"
  ...
  homebridge-mqttthing = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      sources."@homebridge/plugin-ui-utils-1.0.3"
      ...
      sources."extend-3.0.2"
      sources."fakegato-history-0.6.5"
      ...
      sources."glob-7.2.3"
      sources."google-auth-library-9.14.1"
      sources."googleapis-144.0.0"
      ...
      sources."hb-lib-tools-1.2.4"
      sources."help-me-3.0.0"
      sources."homebridge-lib-6.7.5"
  ...
  homebridge-nefit-easy = nodeEnv.buildNodePackage {
    ...
    version = "2.3.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/homebridge-nefit-easy/-/homebridge-nefit-easy-2.3.1.tgz";
      sha512 = "kUhkBxKZ0ESfeXa7L6kMBCZF2yayk4j6Tfq4ux64iS7XxhGbQpkdVERvK7MRAfQXwqsqWqN0A8yJY4a1u4xz3A==";
    };
    dependencies = [
  ...
  homebridge-xiaomi-roborock-vacuum = nodeEnv.buildNodePackage {
    ...
    version = "0.32.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/homebridge-xiaomi-roborock-vacuum/-/homebridge-xiaomi-roborock-vacuum-0.32.0.tgz";
      sha512 = "yaoYVtnUUCnzpCNmuRqqd5u7E7jBuaGBbvvqc2daxnieYNkA+ba38PEu/5518fE5g6nAX5xWUyMTcuUWyEa1nw==";
    };
    dependencies = [
