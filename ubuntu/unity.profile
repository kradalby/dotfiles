...
[core]
s0_active_plugins = core;composite;opengl;copytex;place;commands;wall;vpswitch;session;mousepoll;snap;move;regex;compiztoolbox;animation;imgpng;grid;unitymtgrabhandles;resize;workarounds;expo;ezoom;staticswitcher;fade;scale;unityshell;
...
s0_outputs = 1920x1200+0+0;1440x900+1920+300;
...
s0_rotate_to_1_window_key = <Control><Alt><Super>Right
s0_rotate_to_2_window_key = <Control><Alt><Super>Left
